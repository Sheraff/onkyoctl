...
| `0x004` | Power toggle | Public A-9010 RI tables | No | No | | Excluded from production safe mode; avoid toggle commands for automation. |
| `0x005` | Mute toggle | Public A-9010 RI tables | No | No | | Keep out of production allowlist until tested. |
...
| `0x0D5` | Next input | Public A-9010 RI tables | No | No | | Keep out of production allowlist until tested. |
| `0x0D6` | Previous input | Public A-9010 RI tables | No | No | | Keep out of production allowlist until tested. |
